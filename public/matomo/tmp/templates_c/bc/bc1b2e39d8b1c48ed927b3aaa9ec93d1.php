...
class __TwigTemplate_e716f01224968b9de8ae5ff41df913f1 extends Template
{
    private $source;
    private $macros = [];
...
{% for visitor in dataTable.getRows() %}
    ...
    {{ visitorRow }}
{% endfor %}
", "@Live/_dataTableViz_visitorLog.twig", "/home/gascon/Projets/creabat/public/matomo/plugins/Live/templates/_dataTableViz_visitorLog.twig");
    }
}
