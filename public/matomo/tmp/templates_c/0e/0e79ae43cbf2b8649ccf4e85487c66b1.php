...
class __TwigTemplate_5aa1cf33a7b88a39c9b3f42f84de2fae extends Template
{
    private $source;
    private $macros = [];
...
<script>\$(document).ready(function () { require('{{ jsNamespace }}').{{ jsClass }}.initElements(); });</script>", "@CoreHome\\_uiControl.twig", "/home/gascon/Projets/creabat/public/matomo/plugins/CoreHome/templates/_uiControl.twig");
    }
}
