...
class __TwigTemplate_2d51c1ef5788c59f88f0c6335d523ad3 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"RealTimeMap_container\">
        ...
        if (((twig_get_attribute($this->env, $this->source, ($context["config"] ?? null), "showFooterMessage", [], "any", true, true, false, 8)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["config"] ?? null), "showFooterMessage", [], "any", false, false, false, 8), true)) : (true))) {
            ...
            echo \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('translate')->getCallable()("UserCountryMap_ShowingVisits"), "html", null, true);
            echo "
    ...
    ";
        ...
        if ((isset($context["userIsSuperUser"]) || array_key_exists("userIsSuperUser", $context) ? $context["userIsSuperUser"] : (function () { throw new RuntimeError('Variable "userIsSuperUser" does not exist.', 27, $this->source); })())) {
            ...
            <p>";
            // line 29
            echo \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('translate')->getCallable()("UserCountryMap_NoVisitsInfo"), "html", null, true);
            echo "</p>
            <p>";
            // line 30
            echo \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('translate')->getCallable()("UserCountryMap_NoVisitsInfo2"), "html", null, true);
            echo "</p>
        </div>
    ";
        }
...
<script type=\"text/javascript\">UserCountryMap.RealtimeMap.initElements();</script>", "@UserCountryMap/realtimeMap.twig", "/home/gascon/Projets/creabat/public/matomo/plugins/UserCountryMap/templates/realtimeMap.twig");
    }
}
